...
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports btn_i]
...
set_property BEL D5LUT [get_cells {leds[0]_i_4}]
set_property LOC SLICE_X31Y192 [get_cells {leds[0]_i_4}]
set_property BEL B6LUT [get_cells {leds[0]_i_5}]
set_property LOC SLICE_X39Y193 [get_cells {leds[0]_i_5}]
set_property BEL A5LUT [get_cells {leds[4]_i_2}]
set_property LOC SLICE_X65Y188 [get_cells {leds[4]_i_2}]
set_property BEL A6LUT [get_cells {leds[4]_i_4}]
set_property LOC SLICE_X77Y4 [get_cells {leds[4]_i_4}]
